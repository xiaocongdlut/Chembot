...
options = {
  ...
  map_frame = "odom_cat",                                    -- 地图坐标系的名字  map
  tracking_frame = "base_footprint",                         -- 将所有传感器数据转换到这个坐标系下默认imu_link，在有IMU的情况下将其他数据转到IMU下，因为IMU频率高，转到其他坐标系下需要转换次数更多
  published_frame = "base_footprint",                        -- tf: map -> odom
  odom_frame = "odom_cat",                                  -- 里程计的坐标系名字
