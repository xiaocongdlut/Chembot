...
Navigation::Navigation()
{
    ...
    target_pose_one.position.x = 4.75;
    target_pose_one.position.y = 0.72;
    ...
    pointCloud2_sub_ = node_.subscribe("/new_cloud", 100, &Navigation::PointCloud2Callback, this);
